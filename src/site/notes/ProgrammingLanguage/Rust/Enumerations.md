---
{"dg-publish":true,"tags":["Rust","프로그래밍언어"],"permalink":"/programming-language/rust/enumerations/","dgPassFrontmatter":true,"created":"2024-07-16T15:53:50.423+09:00","updated":"2024-07-21T23:21:43.453+09:00"}
---
...
열거형에 대한 메서드를 사용하는 방법은 구조체에 대한 메서드를 사용하는 방법과 같다. `match`나 `if let` 등 열거형과 궁합이 좋은 제어 흐름 연산자는 이 글에서 다루는 범위를 넘어서며 자세한 내용은 [[ProgrammingLanguage/Rust/FlowControl\|이 글]]에서 확인할 수 있다.
...
### 더보기
+ [[ProgrammingLanguage/Rust/FlowControl#^37e07f\|match]]
+ [[ProgrammingLanguage/Rust/FlowControl#^9f459b\|if let]]
